...
import { ref } from "vue";
import { imgCardData } from "@/_mockApis/components/widget/card";
</script>
...
<template>
  ...
  <!-- ----------------------------------------------------------------------------- -->
  <v-row>
    <v-col cols="12" lg="4" v-for="(item, i) in imgCardData" :key="i">
      <v-card elevation="10" class="overflow-hidden">
        <v-img :src="item.image"  cover  class="w-100"  height="250"/>
